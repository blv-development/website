"""
Django settings for blvd project.
...
SECRET_KEY = 'django-insecure-hrdm_4ob_f%5hv*y(kky18j)mmfkuyff(tlf&f!cy4tvp_&+fu'
...
WSGI_APPLICATION = 'blvd.wsgi.application'
